...
_$VegetationRecordImpl _$$VegetationRecordImplFromJson(
  ...
  distanceAlongTransectM:
      (json['distanceAlongTransectM'] as num?)?.toDouble() ?? 0.0,
  latitude: (json['latitude'] as num).toDouble(),
  longitude: (json['longitude'] as num).toDouble(),
  elevationM: (json['elevationM'] as num?)?.toDouble(),
  accuracyM: (json['accuracyM'] as num?)?.toDouble(),
  canopyHeightM: (json['canopyHeightM'] as num?)?.toDouble() ?? 0.0,
  thatchHeightM: (json['thatchHeightM'] as num?)?.toDouble() ?? 0.0,
  ...
  rtkPointNumber: json['rtkPointNumber'] as String?,
...
Map<String, dynamic> _$$VegetationRecordImplToJson(
  ...
  'protocolCode': instance.protocolCode,
  'subclass': instance.subclass,
  'rtkPointNumber': instance.rtkPointNumber,
